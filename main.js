document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', async e => {
    ...
    try {
      ...
      console.error('Send order error:', { message: error?.message, error });
      alert(`Xin lỗi, đơn hàng chưa được gửi. ${error?.message || 'Vui lòng thử lại sau hoặc liên hệ Lẩu Nhà qua số 081 994 3904.'}`);
